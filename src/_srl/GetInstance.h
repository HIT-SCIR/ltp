...
private:
    ...
    void test_and_open_(const std::vector<std::vector<std::string> >& select_features,
            const std::vector<std::string>& features,
            const std::string& feature_folder);
    void test_noun_set_(const std::string& feature_folder)
    {
        test_and_open_(m_noun_select_features, 
            m_configuration.get_argu_config().get_noun_feature_names(), feature_folder);
    }
    void test_verb_set_(const std::string& feature_folder)
    {
        test_and_open_(m_verb_select_features,
            m_configuration.get_argu_config().get_verb_feature_names(), feature_folder);
    }
    void output_(std::ofstream& out_stream, 
...
private:
    ...
    std::vector<std::vector<std::string> >  m_noun_select_features;
    std::vector<std::vector<std::string> >  m_verb_select_features;
